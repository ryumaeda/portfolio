  ...
  return (
    <div className="min-h-screen bg-black text-white p-10">
      ...
      <div className="space-y-8">
        <section>
          <p className="mb-4">
            This privacy policy applies to the Game Thinker AI app (hereby
            referred to as Application) for mobile devices that was created by
            Ryu Maeda (hereby referred to as Service Provider) as an Ad
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3">Opt-Out Rights</h2>
          <p className="mb-4">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3">Data Retention Policy</h2>
          <p className="mb-4">
            The Service Provider will retain User Provided data for as long as
            you use the Application and for a reasonable time thereafter. If
            youd like them to delete User Provided Data that you have provided
            via the Application, please contact them at ryumaeda86@gmail.com and
        ...
        <section>
          ...
          <p className="mb-4">
            ...
            please contact the Service Provider (ryumaeda86@gmail.com) so that
        ...
        <section>
          ...
          <p className="mb-4">
            ...
            the Service Provider via email at ryumaeda86@gmail.com.
          </p>
        </section>
      </div>
    </div>
